...
const getAvgTxnsPastSixMonths = (chain, address) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const pastSixMonthsTxns = yield node_1.default.Web3API.account.getTransactions({ chain: chain, address: address, from_date: fromDate, to_date: toDate });
...
const getAccountAgeMonths = (chain, address) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let allTxns = yield node_1.default.Web3API.account.getTransactions({ chain: chain, address: address });
    ...
    if ((allTxns === null || allTxns === void 0 ? void 0 : allTxns['total']) && (allTxns === null || allTxns === void 0 ? void 0 : allTxns['page_size']) && (allTxns === null || allTxns === void 0 ? void 0 : allTxns['total']) !== 0) {
        ...
        if ((allTxns === null || allTxns === void 0 ? void 0 : allTxns['total']) > (allTxns === null || allTxns === void 0 ? void 0 : allTxns['page_size'])) {
            ...
            allTxns = yield node_1.default.Web3API.account.getTransactions({ chain: chain, address: address, offset: offset });
